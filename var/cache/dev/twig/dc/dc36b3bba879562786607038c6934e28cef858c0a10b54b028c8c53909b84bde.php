...
/* base.html.twig */
class __TwigTemplate_683c30d4297a6f164af4c302b6bd738b4ca0d0bbf5c085989c6707e9ee0c20df extends Template
{
    private $source;
    private $macros = [];
    ...
    <body>
        ...
        echo "\">Administration</a>
                ...
                <li class=\"nav-item\">
                  <a class=\"nav-link\" href=\"";
        // line 27
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("types");
        echo "\">Types</a>
              </li>
              <li class=\"nav-item\">
                <a class=\"nav-link\" href=\"";
        // line 30
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_types");
        echo "\">Administration</a>
            </li>
              </ul>
            </div>
...
";
    ...
    {
        return array (  204 => 39,  186 => 38,  168 => 37,  150 => 8,  131 => 5,  116 => 40,  113 => 39,  111 => 38,  107 => 37,  97 => 30,  91 => 27,  85 => 24,  72 => 14,  65 => 9,  63 => 8,  59 => 7,  54 => 5,  48 => 1,);
    }
...
<html>
    ...
    <body>
        ...
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">
            <a class=\"navbar-brand\" href=\"{{path(\"aliments\")}}\">Home</a>
            <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor01\" aria-controls=\"navbarColor01\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
              <span class=\"navbar-toggler-icon\"></span>
            </button>
            <div class=\"collapse navbar-collapse\" id=\"navbarColor01\">
              <ul class=\"navbar-nav mr-auto\">
                ...
                <li class=\"nav-item\">
                  <a class=\"nav-link\" href=\"{{path('types')}}\">Types</a>
              </li>
              <li class=\"nav-item\">
                <a class=\"nav-link\" href=\"{{path('admin_types')}}\">Administration</a>
            </li>
              </ul>
            </div>
          </nav>
        ...
        <h1 class=\"border border-primary bg-primary p-2 m-2 text-white\">{% block monTitre %}{% endblock %}</h1>
        {% block body %}{% endblock %}
...
", "base.html.twig", "/Applications/MAMP/htdocs/aliments/templates/base.html.twig");
    }
}
